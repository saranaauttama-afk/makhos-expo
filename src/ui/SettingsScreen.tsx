...
const styles = StyleSheet.create({
  ...
  toggleRow: { backgroundColor: PANEL_DARK, borderWidth: 2, borderColor: LINE, minHeight: 60, paddingHorizontal: 10, paddingVertical: 8, flexDirection: 'row', alignItems: 'center', gap: 10 },

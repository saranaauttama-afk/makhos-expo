...
const styles = StyleSheet.create({
  ...
  backButton: { paddingHorizontal: 10, paddingVertical: 8, borderWidth: 2, borderColor: LINE, backgroundColor: PANEL_DARK },
  backButtonText: { color: WHITE, fontSize: 11, fontWeight: '900', letterSpacing: 1 },
  marquee: { flex: 1, minHeight: 34, backgroundColor: PANEL_DARK, borderWidth: 2, borderColor: CYAN, alignItems: 'center', justifyContent: 'center' },
  ...
  heroPanel: { backgroundColor: PANEL_ALT, borderWidth: 3, borderColor: GOLD, padding: 12, gap: 8, alignItems: 'center' },
  heroBadge: {
    width: 58,
    height: 58,
  ...
  rewardChip: { flex: 1, minHeight: 70, backgroundColor: PANEL_DARK, borderWidth: 2, alignItems: 'center', justifyContent: 'center', gap: 4 },
  ...
  ladderPanel: { backgroundColor: PANEL, borderWidth: 3, borderColor: MINT, padding: 12, gap: 8 },
  ...
  rewardPanel: { backgroundColor: PANEL, borderWidth: 3, borderColor: CYAN, padding: 12, gap: 8 },
  payoutGrid: { gap: 8 },
  payoutCard: { minHeight: 68, backgroundColor: PANEL_DARK, borderWidth: 2, borderColor: LINE, padding: 10, gap: 4 },
  payoutTitle: { color: CYAN, fontSize: 11, fontWeight: '900', letterSpacing: 0.8 },
  payoutCopy: { color: WHITE, fontSize: 11, lineHeight: 16 },
  offerPanel: { backgroundColor: PANEL, borderWidth: 3, borderColor: PINK, padding: 12, gap: 8 },
  offerTitle: { color: PINK, fontSize: 13, fontWeight: '900', letterSpacing: 0.9 },
  offerCopy: { color: WHITE, fontSize: 11, lineHeight: 16 },
  offerButtons: { gap: 8 },
  primaryOfferButton: { minHeight: 44, backgroundColor: PANEL_DARK, borderWidth: 2, borderColor: PINK, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 },
  primaryOfferText: { color: PINK, fontSize: 11, fontWeight: '900', letterSpacing: 0.7, textAlign: 'center' },
  secondaryOfferButton: { minHeight: 42, backgroundColor: '#33203f', borderWidth: 2, borderColor: GOLD, alignItems: 'center', justifyContent: 'center', paddingHorizontal: 10 },
  secondaryOfferText: { color: GOLD, fontSize: 11, fontWeight: '900', letterSpacing: 0.7, textAlign: 'center' },
  ctaPanel: { gap: 8 },
  primaryButton: { minHeight: 50, backgroundColor: PANEL_ALT, borderWidth: 3, borderColor: CYAN, alignItems: 'center', justifyContent: 'center' },
  primaryButtonText: { color: WHITE, fontSize: 13, fontWeight: '900', letterSpacing: 0.9 },
  secondaryButton: { minHeight: 44, backgroundColor: PANEL, borderWidth: 2, borderColor: LINE, alignItems: 'center', justifyContent: 'center' },

...
const styles = StyleSheet.create({
  ...
  offerCard: { backgroundColor: PANEL, borderWidth: 3, padding: 12, gap: 8 },
  ...
  offerButton: { minHeight: 42, borderWidth: 2, backgroundColor: PANEL_DARK, alignItems: 'center', justifyContent: 'center' },
  offerButtonText: { fontSize: 12, fontWeight: '900', letterSpacing: 0.9 },
  infoPanel: { backgroundColor: PANEL_ALT, borderWidth: 2, borderColor: LINE, padding: 12, gap: 4 },

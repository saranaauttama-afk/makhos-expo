...
`.tmp/position-suite/` and are not version controlled.
...
chosen move belongs to its full accepted set; W/D/L compares the returned root
score sign. Reports calculate development verified accuracy and holdout
